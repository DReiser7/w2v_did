...
python ./train_classifier_english.py "config/config_fiviapas_english_accents.json" 4000
python ./train_classifier_english.py "config/config_fiviapas_english_accents.json" 5000
python ./train_classifier_english.py "config/config_fiviapas_english_accents.json" 6000