...
class ComVoiceSpanishAccentCorpusConfig(datasets.BuilderConfig):
    ...
    def __init__(self, **kwargs):
        ...
        """
        super(ComVoiceSpanishAccentCorpusConfig, self).__init__(version=datasets.Version("2.1.0", ""), **kwargs)
...
class ComVoiceSpanishAccentCorpus(datasets.GeneratorBasedBuilder):
    """DialectSpeechCorpus dataset."""

    BUILDER_CONFIGS = [
        ComVoiceSpanishAccentCorpusConfig(name="clean", description="'Clean' speech."),
    ]
