...
class ComVoiceEnglishAccentCorpusConfig(datasets.BuilderConfig):
    ...
    def __init__(self, **kwargs):
        ...
        """
        super(ComVoiceEnglishAccentCorpusConfig, self).__init__(version=datasets.Version("2.1.0", ""), **kwargs)
...
class ComVoiceEnglishAccentCorpus(datasets.GeneratorBasedBuilder):
    """DialectSpeechCorpus dataset."""

    BUILDER_CONFIGS = [
        ComVoiceEnglishAccentCorpusConfig(name="clean", description="'Clean' speech."),
    ]
