...
def main():
    ...
    train_dataset = datasets.load_dataset("DidDataset", split="train", cache_dir=model_args.cache_dir)
    eval_dataset = datasets.load_dataset("DidDataset", split="test", cache_dir=model_args.cache_dir)
